...
public class HunspellStemmer {
  ...
  private CharacterUtils charUtils = CharacterUtils.getInstance(Version.LUCENE_44);
  ...
  public static void main(String[] args) throws IOException, ParseException {
    ...
    HunspellDictionary dictionary = new HunspellDictionary(affixInputStream, dicInputStream, Version.LUCENE_44, ignoreCase);
