...
public class TestVersion extends LuceneTestCase {
  ...
  public void test() {
    ...
    assertTrue(Version.LUCENE_44.onOrAfter(Version.LUCENE_31));
    assertTrue(Version.LUCENE_44.onOrAfter(Version.LUCENE_44));
    assertFalse(Version.LUCENE_30.onOrAfter(Version.LUCENE_31));
  }

  public void testParseLeniently() {
    assertEquals(Version.LUCENE_44, Version.parseLeniently("4.0"));
    assertEquals(Version.LUCENE_44, Version.parseLeniently("LUCENE_44"));
